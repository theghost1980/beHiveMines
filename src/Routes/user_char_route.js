...
router.post('/create_char', function(req,res){
    ...
    user_char.create({ username: username, char_id: char_id, char_name: char_name, char_stats: char_stats, char_inventory: char_inventory, char_truck: char_truck }, function(err, new_user_char){
        if (err){ 
